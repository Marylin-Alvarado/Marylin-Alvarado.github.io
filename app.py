...
app.config['MYSQL_DB'] = 'app_pasteleria'
...
def registro():
    ...
    cur = mysql.connection.cursor()
    cur.execute("SELECT * FROM pastel_interes")
    ...
    if request.method == 'GET':
        ...
        notificacion.message="ya te encuentras registrado en 🤵 Dulce Capricho 👰, por favor inicia sesión y empieza a descubrir este nuevo mundo."
        notificacion.send()
